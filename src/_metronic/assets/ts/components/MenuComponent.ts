...
class MenuComponent {
  ...
  private _getDropdownPopperConfig = (item: HTMLElement) => {
    ...
    // Offset
    // Popper espera numeros [skidding, distance]. Los offsets de Metronic vienen como
    // string con unidades (p.ej. "-15px, 0"); si se pasan como texto, Popper produce un
    // transform NaN y el submenu se va arriba-izquierda. Los parseamos a numero.
